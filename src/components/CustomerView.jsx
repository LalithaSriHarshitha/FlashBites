...
export default function CustomerView({
  ...
  const [selectedRestaurantId, setSelectedRestaurantId] = useState(restaurants[0]?.id || 'rest-udipi');
  ...
  const [deliveryAddress, setDeliveryAddress] = useState('Door No 4-5-12, Brodipet 5th Line, Guntur City, AP 522002');
  ...
  const filteredMenuItems = (activeRestaurant.menu || []).filter((item) => {
